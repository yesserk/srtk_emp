		...
		<div class="container-login100" style="background-image: url('auth/images/bag.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					liste des voyages du personnel
				</span>
				<form class="login100-form validate-form p-b-33 p-t-5" method="get" action="/list_voyage">
                @csrf
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
					<input id="cin" type="text" class="input100 @error('email') is-invalid @enderror" name="cin" value="{{ old('cin') }}" required autocomplete="email"  placeholder="Matricule">
					...
					<input id="date_deb" type="date" class=" input100 " name="date_deb" value="{{ old('date_deb') }}"  autocomplete="email"  placeholder="date_debute">
						<span class="focus-input100" data-placeholder="De"></span>
                        @error('cin')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
					...
					<div class="wrap-input100 " >
					<input id="date_fin" type="date" class="input100 " name="date_fin" value="{{ old('date_fin') }}"  autocomplete="email"  placeholder="date_fin">
						<span class="focus-input100" data-placeholder=" Jusqu'a"></span>
